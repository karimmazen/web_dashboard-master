...
class _exerciseState extends State<exercise> {
  ...
  //var primaryExerciseController =  new TextEditingController();
  //var secondaryExerciseController = new TextEditingController();
...
var exerciseNameController = new TextEditingController();
var exerciseTypeController = new TextEditingController();
var primaryMuscleController = new TextEditingController();
var secondaryMuscleController = new TextEditingController();

final DatabaseRef = FirebaseDatabase.instance.reference();
void insertData(String exerciseName, String exerciseType, String primaryMuscle,
    String secondaryMuscle) {
  DatabaseRef.child('Exercise Added').set({
  ...
  secondaryMuscleController.clear();
}
      ...
      TextButton(
          onPressed: () {
            if (exerciseNameController.text.isNotEmpty &&
                exerciseTypeController.text.isNotEmpty &&
                primaryMuscleController.text.isNotEmpty &&
                secondaryMuscleController.text.isNotEmpty) {
              insertData(
